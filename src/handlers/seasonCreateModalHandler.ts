...
export class SeasonCreateModalHandler implements ModalHandler {
    ...
    private async handleStep1(interaction: ModalSubmitInteraction<CacheType>): Promise<void> {
        ...
        try {
            ...
            const claimTimeout = interaction.fields.getTextInputValue('claimTimeoutInput'); // Optional
            ...
            if (claimTimeout) currentData.claimTimeout = claimTimeout;
            // Add origin tracking for announcements
            currentData.guildId = interaction.guildId;
